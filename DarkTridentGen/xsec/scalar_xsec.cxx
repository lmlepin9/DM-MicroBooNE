...
int main(int argc, char** argv)
{
	...
	//string rootFilename(Form("./cross_section_%.2f_ratio_%.2f_scalar.root",mV,mass_ratio));

	string rootFilename(Form("./cross_section_%.3f_ratio_%.2f_scalar.root",mV,mass_ratio));
